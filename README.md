...
1. Download Linux Distro and install Anaconda using ```bash bash ~/Downloads/Anaconda3-2025.06-0-Linux-x86_64.sh```
2. Once Anaconda distribution is downloaded and installed, follow the instructions below.
    ...
    ```
3. It activates conda shell by default and we need to deactivate conda shell and activate it when required. It can deactivated by modifying .condarc file with *auto_activate: false* or by using below commands.
    ```bash
...
8. To change/point existing PyCharm to Anaconda3, change Python interpreter to point anaconda3 under project settings in PyCharm.
